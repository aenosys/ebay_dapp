...
module.exports = function(callback) {
 current_time = Math.round(new Date() / 1000);
    ...
    EcommerceStore.deployed().then(function(i) {i.addProductToStore('iphone 5', 'Cell Phones & Accessories', 'QmStqeYPDCTbgKGUwns2nZixC5dBDactoCe1FB8htpmrt1', 'QmbLRFj5U6UGTy3o9Zt8jEnVDuAw2GKzvrrv3RED9wyGRk', current_time, current_time + 1800, 2*amt_1, 0).then(function(f) {console.log(f)})});
